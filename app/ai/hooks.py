...
class HookEngine(BaseAIEngine):
    ...
    def get_system_prompt(self) -> str:
        return (
            ...
            f"QOIDALAR:\n"
            f"- Har bir hook BIRINCHI 3 SONIYADA aytiladi\n"
            f"- Tomoshabinni DARHOL ushlab turishi kerak\n"
            f"- Qisqa, kuchli, emotsional\n"
            f"- O'zbek tilida, oddiy va tushunarli\n"
            f"- Curiosity gap yarating — javobni bilish uchun ko'rish kerak\n"
            f"- Raqamlar va aniq natijalar ishlating\n"
            f"- Har bir hook 1-2 qator, 10-15 so'z"
        )
