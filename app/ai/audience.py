...
class AudienceEngine(BaseAIEngine):
    ...
    def get_system_prompt(self) -> str:
        return (
            ...
            f"═══ AUDITORIYA PROFILI ═══\n"
            f"Auditoriya faqat fermer EMAS — uy hovlisida ekadiganlar, bog'dorlar, oddiy aholi!\n"
            f"- 25-55 yosh, erkak ko'p lekin ayol ham bor\n"
            f"- Samarqand va umumiy O'zbekiston\n"
            f"- Uy hovlisida pomidor, bodring ekadiganlar (ENG KATTA segment)\n"
            f"- Bog'dorlar va dala fermerlar\n"
            f"- Issiqxona egalari\n"
            f"- Shahar atrofida yashab, kichik yer ishlatuvchilar\n\n"
            f"Vazifangiz:\n"
