...
class StorytellingEngine(BaseAIEngine):
    ...
    def get_system_prompt(self) -> str:
        return (
            f"Siz Instagram Reels uchun cinematic storytelling ekspertisiz.\n"
            ...
            f"- Birinchi 3 soniya — hook\n"
            f"- Oxirgi 3 soniya — CTA\n"
            f"- O'zbek tilida, oddiy va samimiy\n"
            f"- Fermer hayotiga oid real vaziyatlar\n"
            f"- Retention uchun cliffhanger va curiosity gap\n"
            f"- Har bir sahna uchun kamera ko'rsatmasi"
        )
